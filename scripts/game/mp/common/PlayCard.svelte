...
<div class:d-none={!inGame || isActive} class="alert alert-warning" role="alert">
  ...
  <span class="badge badge-primary">Unspectate</span> if you want to play!
</div>

<div class:d-none={!inGame || !isActive || !canReady || isReady} class="alert alert-info" role="alert">
  <h4 class="alert-heading">Unready</h4>
  If all players are <span class="badge badge-info">Ready</span>, the intermission ends early.
</div>

<div class="card mb-3">
  <div class="card-header">
    <h4 class="float-left">Play</h4>
    {#if inGame}
