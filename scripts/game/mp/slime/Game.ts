...
export class Game {
  ...
  private readonly p1 = new Player()
  private readonly p2 = new Player()
  ...
  getSmoothDelay (): number { return this.smoothDelay }
  getFPS (): number { return 1000 / Math.max(this.smoothDelay, 0.5) }
  hasOpponent (): boolean { return this.hasServerOpponent }
