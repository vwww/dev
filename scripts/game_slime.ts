...
class SlimeController implements IConnectorCallbacks, ISlimeUICallbacks {
  ...
  private readonly ui = new SlimeUI(this)
  private readonly net: IConnector = new PlayerIOConnector(this) // new WebSocketConnector(this)
  private readonly gameDrawer = new GameDrawer(this.game, () => this.net.readyState())
